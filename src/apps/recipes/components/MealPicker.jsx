...
const styles = {
  ...
  modal: { backgroundColor: colors.white, borderTopLeftRadius: borderRadius.xl, borderTopRightRadius: borderRadius.xl, width: '100%', maxWidth: '500px', maxHeight: '70vh', display: 'flex', flexDirection: 'column', boxShadow: shadows.lg },
  ...
  title: { fontFamily: fonts.heading, fontSize: fontSizes.lg, color: colors.forest, margin: 0 },
  ...
  searchContainer: { padding: spacing.md, paddingTop: spacing.sm, paddingBottom: spacing.sm, borderBottom: `1px solid ${colors.warmGray}` },
  searchInput: { ...commonStyles.input, padding: spacing.sm },
  ...
  recipeItem: { width: '100%', display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: spacing.md, backgroundColor: 'transparent', border: 'none', borderRadius: borderRadius.md, cursor: 'pointer', fontFamily: fonts.body, textAlign: 'left' },
  recipeInfo: { display: 'flex', flexDirection: 'column', gap: '2px' },
